...
Let's load in a few more libraries that we'll need for plotting
```{r, include = F}
library(sna)
library(ggraph)
```
...
```{r echo=FALSE, out.width = c("50%","50"), fig.align= 'center'}
knitr::include_graphics("img/winds2020.jpeg")
knitr::include_graphics("img/yonder1831.jpeg")
```
